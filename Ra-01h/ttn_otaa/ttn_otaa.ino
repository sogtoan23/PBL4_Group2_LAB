 ...
 *
 *******************************************************************************/
#define CFG_as923_1 1          // VN 923–925 MHz
// #define CFG_as923jp 1       // AS923 Group-1 (920–923 MHz)
...
void setup() {
    ...
    LMIC_reset();
    LMIC_setClockError(MAX_CLOCK_ERROR * 10 / 100);   // nới cửa sổ RX
    // LMIC_setRx2Params(923200000UL, 2); // Join bền chắc:
    LMIC_setAdrMode(0);
